"""
Test script for controle_base_prestacoes checks.
Uses file-based API client data loading for stable testing.
"""
import sys
import os
...
class MockAPI:
    ...
    def __init__(self):
        ...
        self._use_lazy_loading = True  # If True, fetch expenses on-demand from API
    ...
    def get_expense_by_id(self, expense_id):
        ...
        # If not found and lazy loading is enabled, fetch from API
            ...
            if response.returncode == 0:
                try:
                    ...
                    if data.get('success') and 'data' in data and data['data']:
                        ...
                        # Extract data from nested includes
...
def main():
    ...
    # Load data
    api.get_or_load_period_expenses("2025-08-01", "2025-08-31")
