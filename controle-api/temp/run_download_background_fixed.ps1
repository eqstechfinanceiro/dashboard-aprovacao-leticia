...
# Iniciar o processo Python com stdout e stderr separados
$process = Start-Process -FilePath $pythonPath -ArgumentList $scriptPath -RedirectStandardOutput $logPath -RedirectStandardError "$logPath.err" -PassThru -WindowStyle Hidden
