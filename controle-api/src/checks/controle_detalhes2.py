"""
Checks de coluna para a tabela controle_detalhes2.
Fonte: CONTROLE - VEXPENSES - MAIO - 2026 (1).xlsb → Detalhes2
...
from src.checks.shared_db import (
    ...
    CurrencyDBCheck, ExpenseTypeDBCheck
)

TABLE = "controle_detalhes2"
